    ...
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5">
            <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">แนะนำสถานที่ <br><span class="fs-3">{{$RecommendPlaces->title_name}}</div>
                ...
                @if ($RecommendPlaces->photos->whereIn('post_photo_status', ['1', '2'])->count() > 0)
                <h5 class="text-secondary">รูปภาพ</h5>
                <div class="row">
                    @foreach ($RecommendPlaces->photos->whereIn('post_photo_status', ['1', '2']) as $index => $photo)
                ...
                <!-- วิดีโอแนบ -->
                @if ($RecommendPlaces->videos->count() > 0)
                <h5 class="text-secondary mt-4">วิดีโอ</h5>
                @foreach ($RecommendPlaces->videos as $video)
                <div class="mb-4">
