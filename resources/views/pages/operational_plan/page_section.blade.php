...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5">
            <div class="fs-1 fw-bold mb-4 text-center">{{ $OperationalPlanType->type_name }}</div>
            ...
            <table class="table">
                @foreach($OperationalPlanSection as $detail)
                <tr>
                    <td><a href="{{route('OperationalPlanShowDetailsPages',$detail->id)}}">{{ $detail->section_name }}</a></td>
                </tr>
                @endforeach
            </table>
