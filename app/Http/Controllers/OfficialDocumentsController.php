...
{
    public function OfficialDocumentsHome()
    {
    ...
    public function OfficialDocumentsCreate(Request $request)
    {
        $request->validate([
    ...
    public function OfficialDocumentsUpdate(Request $request, $id)
    {
        $request->validate([
            'date' => 'nullable|date',
            'title_name' => 'nullable|string',
    ...
    public function OfficialDocumentsDelete($id)
    {
