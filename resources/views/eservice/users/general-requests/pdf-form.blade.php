...
<body>
    ...
    <div class="title_doc">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/contect/logo.png'))) }}"
            alt="Logo" height="100"> <br><strong>แบบฟอร์มคำร้องทั่วไป</strong>
    </div>
    <div class="box_text" style="text-align: right;">
        <span style="line-height: 0.7;">
            องค์การบริหารส่วนแปลงยาว<br>
    ...
    <div class="box_text" style="text-align: left;">
        <span>เรียน นายกองค์การบริหารส่วนตำบลแปลงยาว</span>
    </div>
    <div class="box_text" style="text-align: left;">
    ...
    <div class="box_text" style="text-align: left; margin-left:5rem">
        <span>เรื่องที่ร้องต่อองค์การบริหารส่วนแปลงยาวกรณี</span><span class="dotted-line"
            style="min-width: 50%; text-align: start;">{{ $form->request_details }}</span>
    </div>
    <div class="box_text" style="text-align: left;">
        <span style="margin-left:5rem;">ข้าพเจ้าขอความอนุเคราะห์ให้องค์การบริหารส่วนแปลงยาวดำเนินการ</span>
