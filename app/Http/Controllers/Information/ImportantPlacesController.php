...
class ImportantPlacesController extends Controller
{
    public function  ImportantPlacesPage()
    {
        ...
        return view('basic_information.important_places.page', compact( 'listDetail', 'basicInfoType','personnelAgencies','AuthorityDetails','OperationalPlanMenu','PerfResultsMenu'));
    }
    ...
    public function ImportantPlacesShowDetails($id)
    {
        ...
        return view('basic_information.important_places.show_details', compact('listDetail','personnelAgencies','AuthorityDetails','OperationalPlanMenu','PerfResultsMenu'));
    }
}
