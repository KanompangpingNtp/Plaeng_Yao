...
<div class="container">
    ...
    <form action="{{route('GeneralRequestsFormCreate')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="request_details" class="form-label">เรื่องร้องเรียนต่อองค์การบริหารส่วนแปลงยาวกรณี<span class="text-danger">*</span></label>
            <textarea class="form-control" id="request_details" name="request_details" rows="3" required></textarea>
        </div>

        <div class="mb-3">
            <label for="proceedings" class="form-label">ข้าพเจ้าขอความอนุเคราะห์ให้องค์การบริหารส่วนแปลงยาวดำเนินการ<span class="text-danger">*</span></label>
