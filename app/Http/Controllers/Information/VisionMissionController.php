...
class VisionMissionController extends Controller
{
    public function  VisionMissionPage()
    {
        ...
        return view('basic_information.vision_mission.page',compact('basicInfoDetail','basicInfoType','personnelAgencies','AuthorityDetails','OperationalPlanMenu','PerfResultsMenu'));
    }
}
