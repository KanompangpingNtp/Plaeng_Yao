...
class AdminPerformanceResultsController extends Controller
{
    public function PerformanceResultsType()
    {
        ...
        return view('admin.performance_results.page_type', compact('PerfResultsType'));
    }
    ...
    public function PerformanceResultsShowSection($id)
    {
        ...
        return view('admin.performance_results.page_section', compact('PerfResultsType', 'PerfResultsSection'));
    }
    ...
    public function PerfResultsSubTopicShowSection($id)
    {
        ...
        return view('admin.performance_results.page_sub_topic', compact('PerfResultsSection', 'PerfResultsSubTopic'));
    }
    ...
    public function PerfResultsShowDetails($id)
    {
        ...
        return view('admin.performance_results.page_detail', compact('PerfResultsSubTopic', 'PerfResultsFile'));
    }
