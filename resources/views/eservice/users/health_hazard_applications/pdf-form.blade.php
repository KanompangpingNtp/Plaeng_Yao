...
<body>
    ...
    <div style="width: 100%; display: table;">
        ...
        <div style="display: table-cell; width: 75%; text-align: center; vertical-align: top;">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/navbar/Logo-601.png'))) }}" alt="Logo" height="120" style="margin-right: -180px;">
        </div>
    ...
    <div class="box_text" style="text-align: right; margin-top:1rem;">
        <span>เขียนที่</span>
        <span class="dotted-line" style="width: 32%; text-align: center; line-height: 1;">องค์การบริหารส่วนตำบลคลองแปลงยาว</span>
    </div>
