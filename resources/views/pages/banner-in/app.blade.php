            ...
            <div class=" d-flex flex-column justify-content-center align-items-start">
                ...
                <div class="d-flex justify-content-center align-item-center"
                    ...
                    <div class="row px-4 py-5 justify-content-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.thaigov.go.th/index.php?option=com_k2&view=itemlist&layout=category&task=category&id=250&Itemid=350&lang=th"
                                target="_blank">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://ndwc.disaster.go.th/ndwc/home" target="_blank">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.mdes.go.th/home" target="_blank">
                                <img src="{{ asset('images/banner-in/15.png') }}" alt="15"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.doe.go.th/prd/nakhonnayok" target="_blank">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.nhso.go.th/th/" target="_blank">
                                <img src="{{ asset('images/banner-in/19.png') }}" alt="19"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.thaihealth.or.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/20.png') }}" alt="20"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.doe.go.th/prd/" target="_blank">
                                <img src="{{ asset('images/banner-in/21.png') }}" alt="21"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.womenfund.in.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/22.png') }}" alt="22"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.royaloffice.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/23.png') }}" alt="23"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.prd.go.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/24.png') }}" alt="24"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.rd.go.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/25.png') }}" alt="25"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.bb.go.th/bbweb/" target="_blank">
                                <img src="{{ asset('images/banner-in/26.png') }}" alt="26"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.nacc.go.th/main.php?filename=index" target="_blank">
                                <img src="{{ asset('images/banner-in/27.png') }}" alt="27"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://newweb.ect.go.th/ect_th/th/main" target="_blank">
                                <img src="{{ asset('images/banner-in/28.png') }}" alt="28"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.admincourt.go.th/admincourt/site/" target="_blank">
                                <img src="{{ asset('images/banner-in/29.png') }}" alt="29"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.oag.go.th/home" target="_blank">
                                <img src="{{ asset('images/banner-in/30.png') }}" alt="30"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.krisdika.go.th/wps/portal/general" target="_blank">
                                <img src="{{ asset('images/banner-in/31.png') }}" alt="31"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://dopa.go.th/main/web_index" target="_blank">
                                <img src="{{ asset('images/banner-in/32.png') }}" alt="32"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.moc.go.th/index.php/home.html" target="_blank">
                                <img src="{{ asset('images/banner-in/33.png') }}" alt="33"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.dit.go.th/default.aspx" target="_blank">
                                <img src="{{ asset('images/banner-in/34.png') }}" alt="34"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.dbd.go.th/main.php?filename=index" target="_blank">
                                <img src="{{ asset('images/banner-in/35.png') }}" alt="35"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.moph.go.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/36.png') }}" alt="36"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://thai.tourismthailand.org/home" target="_blank">
                                <img src="{{ asset('images/banner-in/37.png') }}" alt="37"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.baac.or.th/index.php?cover_page=1" target="_blank">
                                <img src="{{ asset('images/banner-in/38.png') }}" alt="38"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="https://www.gsb.or.th/" target="_blank">
                                <img src="{{ asset('images/banner-in/39.png') }}" alt="39"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.glo.or.th/main.php?filename=index" target="_blank">
                                <img src="{{ asset('images/banner-in/40.png') }}" alt="40"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="http://www.aseanthai.net/main.php?filename=index" target="_blank">
                                <img src="{{ asset('images/banner-in/41.png') }}" alt="41"
                                    class="img-fluid img-hover">
                            </a>
                        </div>
