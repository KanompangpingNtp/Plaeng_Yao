...
class AdminCommunityProductsController extends Controller
{
    public function  CommunityProductsAdmin()
    {
        ...
        return view('admin.post.community_products.page', compact('listDetail', 'basicInfoType'));
    }
    ...
    public function CommunityProductShowDertails($id)
    {
        ...
        return view('admin.post.community_products.show_details', compact('listDetail'));
    }
