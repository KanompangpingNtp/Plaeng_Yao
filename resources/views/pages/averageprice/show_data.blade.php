...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center  p-5 ">
            <div class="fs-1 fw-bold mb-4 text-center">ประกาศผู้ชนะการเสนอราคา</div>

            <div class="mt-5">
                <form action="{{route('AveragePriceSearchData')}}" method="GET" class="d-flex justify-content-end">
